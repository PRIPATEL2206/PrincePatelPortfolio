            ...
            <div className={` ${footerTheme[themeIndex].bgcolor} `}>
                <footer className="d-flex flex-wrap justify-content-between align-items-center py-3">
                    <div className="col-md-4 d-flex align-items-center">
                        ...
                        <span className={`mb-3 mb-md-0  ${footerTheme[themeIndex].muteTextColor}`}>© 2023 Prince Patel, ALL Rights Are Reserved <br /> Icon providei by <a href="https://www.flaticon.com/">Flaticon</a> </span>
                    </div>
