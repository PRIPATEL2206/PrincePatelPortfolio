    ...
    <div className={`projectPage ${projectTheme[themeIndex].bgcolor} ${projectTheme[themeIndex].textColor }`}>
      <div className='p-3 container'>
        ...
        <div className="projectFieldContainer">
          ...
          <div className="projectsBoxContainer">
            <div className={`card projectBox  ${projectTheme[themeIndex].cardBgColor}`} style={{ "width": "18rem" }}>
              <img src="https://github.com/PRIPATEL2206/ProjectPhotos/raw/master/Portfolio/photos/projectSS/webDevolopment/informatica.png" className="card-img-top projectSS" alt="Informatica web SS" />
            ...
            <div className={`card projectBox  ${projectTheme[themeIndex].cardBgColor}`} style={{ "width": "18rem" }}>
              <img src="https://github.com/PRIPATEL2206/ProjectPhotos/raw/master/Portfolio/photos/projectSS/webDevolopment/todoWeb.jpg" className="card-img-top projectSS" alt="TODO web SS" />
              <div className="card-body">
            ...
            <div className={`card projectBox  ${projectTheme[themeIndex].cardBgColor}`} style={{ "width": "18rem" }}>
              <img src="https://github.com/PRIPATEL2206/ProjectPhotos/raw/master/Portfolio/photos/projectSS/webDevolopment/celculeterWeb.jpg" className="card-img-top projectSS" alt="calculeter web SS" />
              <div className="card-body">
            ...
            <div className={`card projectBox  ${projectTheme[themeIndex].cardBgColor}`} style={{ "width": "18rem" }}>
              <img src="https://github.com/PRIPATEL2206/ProjectPhotos/raw/master/Portfolio/photos/projectSS/webDevolopment/tempratureconverter.jpg" className="card-img-top projectSS" alt="tempratureconverter web SS" />
              <div className="card-body">
            ...
            <div className={`card projectBox  ${projectTheme[themeIndex].cardBgColor}`} style={{ "width": "18rem" }}>
              <img src="https://github.com/PRIPATEL2206/ProjectPhotos/raw/master/Portfolio/photos/projectSS/webDevolopment/musicPleyer.jpg" className="card-img-top projectSS" alt="musicplayer web SS" />
              <div className="card-body">
        ...
        <div className="projectFieldContainer">
          ...
          <div className="projectsBoxContainer">
            <div className={`card projectBox  ${projectTheme[themeIndex].cardBgColor}`} style={{ "width": "18rem" }}>
              <img src="https://github.com/PRIPATEL2206/ProjectPhotos/raw/master/Portfolio/photos/projectSS/appDevolopment/informaticaApp.png" className="card-img-top " alt="informatica app SS" />
              <div className="card-body">
        ...
        <div className="projectFieldContainer">
          ...
          <div className="projectsBoxContainer">
            <div className={`card projectBox  ${projectTheme[themeIndex].cardBgColor}`} style={{ "width": "18rem" }}>
              <img src="https://github.com/PRIPATEL2206/ProjectPhotos/raw/master/Portfolio/photos/projectSS/gameDevolopment/chessWeb.jpg" className="card-img-top projectSS" alt="chess web game" />
              <div className="card-body">
            ...
            <div className={`card projectBox  ${projectTheme[themeIndex].cardBgColor}`} style={{ "width": "18rem" }}>
              <img src="https://github.com/PRIPATEL2206/ProjectPhotos/raw/master/Portfolio/photos/projectSS/gameDevolopment/snackWeb.jpg" className="card-img-top projectSS" alt="snack web game" />
              <div className="card-body">
            ...
            <div className={`card projectBox  ${projectTheme[themeIndex].cardBgColor}`} style={{ "width": "18rem" }}>
              <img src="https://github.com/PRIPATEL2206/ProjectPhotos/raw/master/Portfolio/photos/projectSS/gameDevolopment/tictactoeWeb.jpg" className="card-img-top projectSS" alt="tic tac toe web game" />
              <div className="card-body">
